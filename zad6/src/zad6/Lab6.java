...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
	  ...
	  public void Rysuj(GL2 gl2,int n){

	        double zwieksz = 2 * Math.PI / n;
	        ...
	        for (int i = 1; i <= n; i++) {
	            ...
	            x = (float) (r * Math.cos(kat));
	            z = (float) (r * Math.sin(kat));
	            
	            gl2.glMaterialfv (GL2.GL_FRONT, GL2.GL_DIFFUSE, materials[6], 6);
	            gl2.glVertex3f( x, -2.0f, z );
	            gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_DIFFUSE, materials[4],4);
	            gl2.glVertex3f( 0.0f, 7.0f, 0.0f);

	            kat = i * zwieksz;

	            gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[1],1);
	            gl2.glVertex3f((float) (r * Math.cos(kat)), -2.0f,(float) (r * Math.sin(kat)));
	            gl2.glEnd();
	...
	public void init(GLAutoDrawable drawable) {
		...
		//gl2.glEnable(GL2.GL_LIGHT3);
		 float[] ambientLevel = { 0.2f, 0.8f, 0.2f, 1f };
